...
var (
	...
	ErrAtomicStoreRequired               = errors.New("fsrecon: ChangeSink requires a BatchSnapshotStore")
	ErrObserverFollowSymlinksUnsupported = errors.New("fsrecon: observer FollowSymlinks is unsupported")
)
